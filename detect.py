...
if __name__ == '__main__':
    ...
    rf = RoboflowOak(model="trash-detection-1fjjc", confidence=0.2, overlap=0.5, version="1", api_key="3OhAiptoY0ftMlIYK0ZJ", rgb=True, depth=False, device=None, device_name="roboflowak", blocking=True)
    while True:
        t0 = time.time()
